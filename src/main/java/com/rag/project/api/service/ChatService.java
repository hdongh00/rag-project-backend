...
public class ChatService {
    ...
    private static final String RAG_PROMPT_TEMPLATE = """
            ...
            [지침]
            1. 사용자가 '안녕', '반가워' 같은 **일상적인 인사나 잡담**을 하면, 굳이 [문서 내용]을 언급하지 말고 자연스럽게 답변하세요. (예: "안녕하세요! 무엇을 도와드릴까요?")
            2. 사용자가 **구체적인 정보**를 물어볼 때만 아래 [문서 내용]을 참고해서 답변하세요.
            3. [문서 내용]에 없는 질문이라면 "문서에 해당 내용이 없습니다"라고 말하거나, [이전 대화 기록]을 참고하세요.
